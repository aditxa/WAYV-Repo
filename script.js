if ("serial" in navigator) {
    class DataCollector {
        ...
        recordResponse(isCorrect, letter) {
            ...
            if (!isCorrect) {
                if (!this.currentMetrics.errors[letter]) {
                    this.currentMetrics.errors[letter] = 0;
                }
                this.currentMetrics.errors[letter]++;
            }
        }
        ...
        finalizeAttempt(totalInputs, correctInputs) {
            ...
            this.currentMetrics.mode = this.mode;
        ...
        saveToCSV() {
            ...
            let csv = "SessionID,Timestamp,Mode,Accuracy,Latency,Attempts,Errors\n";
            ...
            this.data.forEach(entry => {
                ...
                csv += `${this.sessionId},${new Date(entry.timestamp).toISOString()},${entry.mode},${entry.accuracy.toFixed(2)},${entry.latency},${entry.attempts},"${errors}"\n`;
            });
    ...
    class BrailleTeacher {
        ...
        switchMode(newMode) {
            ...
            if (modeSelect) modeSelect.value = newMode;  // ✅ Safe check            
            this.resetState();
        ...
        handleLearningMode(data) {
            ...
            if (data.toLowerCase() === currentLetter) {
                ...
                this.dataCollector.recordResponse(false, currentLetter);
